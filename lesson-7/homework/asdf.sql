...
FROM Products;
5. SELECT SUM(SaleAmount) AS TotalSales_Product7
FROM Sales
WHERE ProductID = 7;
6. SELECT AVG(Age) AS AverageEmployeeAge
FROM Employees;
...
23. SELECT 
    o.CustomerID,
    SUM(CASE WHEN o.Freight > 50 THEN o.Freight ELSE 0 END) AS TotalOver50,
